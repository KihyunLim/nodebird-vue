  ...
  head() {
    return {
      ...
      meta: [{
        ...
        hid: 'ogtitle', name: 'og:title', content: `${this.post.User.nickname}님의 게시글`,
      }, {
        hid: 'ogdesc', name: 'og:description', content: this.post.content,
      }, {
        hid: 'ogimage', property: 'og.image', content: this.post.Images[0] ? this.post.Images[0].src : 'https://uve.nodebird.com/vue-nodebird.png',
      }, {
